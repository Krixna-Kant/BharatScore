                  ...
                  .map((app, index) => (
                    <div key={index} className="border-2 rounded-xl overflow-hidden">
                      ...
                      <div className="p-6 space-y-6">
                        ...
                        {/* Remarks Section */}
                        <div className="mb-6">
                          <h6 className="font-semibold text-gray-900 mb-3">Admin Remarks</h6>
                          <div className="space-y-3">
                            <textarea
                              value={remarksInput}
                            ...
                            <div className="flex gap-2">
                              <Button
                                size="sm"
                                variant="outline"
                                onClick={() => generateAIRemarks(selectedApplication, "approved")}
                                disabled={generatingRemarks}
                                className="text-blue-600 border-blue-300 hover:bg-blue-50"
                              >
                                {generatingRemarks ? "Generating..." : "AI Suggest (Approve)"}
                              </Button>
                              <Button
                                size="sm"
                                variant="outline"
                                onClick={() => generateAIRemarks(selectedApplication, "rejected")}
                                disabled={generatingRemarks}
                                className="text-red-600 border-red-300 hover:bg-red-50"
                              >
                                {generatingRemarks ? "Generating..." : "AI Suggest (Reject)"}
                              </Button>
                              <Button
                                size="sm"
                                variant="outline"
                        ...
                        <div className="flex gap-3 pt-4 border-t">
                          <Button
                            onClick={() => handleStatusUpdate(selectedApplication.clerk_user_id, app.created, "approved")}
                          ...
                          <Button
                            variant="destructive"
                            onClick={() => handleStatusUpdate(selectedApplication.clerk_user_id, app.created, "rejected")}
                            className="flex items-center gap-2"
                            disabled={updating}
                          >
                            {updating ? (
